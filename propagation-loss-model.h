...
};//End class PropagationLossModel


//----------------------LOS n NLOS propagation loss model--------------//
 ...
 */
class LOSnNLOSPropagationLossModel : public PropagationLossModel
{
public:
  /**
   * \brief Get the type ID.
  ...
  LOSnNLOSPropagationLossModel ();
  virtual ~LOSnNLOSPropagationLossModel ();
...
private:
   ...
   * Defined and unimplemented to avoid misuse
   */
  LOSnNLOSPropagationLossModel (const LOSnNLOSPropagationLossModel &);
  /**
   * \brief Copy constructor
   *
   * Defined and unimplemented to avoid misuse
   * \returns
   */
  LOSnNLOSPropagationLossModel & operator = (const LOSnNLOSPropagationLossModel &);
  virtual double DoCalcRxPower (double txPowerDbm,
                                Ptr<MobilityModel> a,
                                Ptr<MobilityModel> b) const;
...
//--------------End LOS n NLOS propagation loss model--------------//
